    ...
    export default {
        computed: {
            crudData() {
                return {
                    crudId: this.crudId,
                    apiRoute: 'apiRoutes.qmembership.professions',
                    permission: 'membership.professions',
                    create: {
                        title: this.$tr('qmemebership.layout.profession.new'),
                        to: 'qmembership.admin.profession.create'
                    },
                    read: {
                        columns: [
                            {
                        ...
                        filters: {},
                        update: {
                            to: 'qmembership.admin.profession.edit',
                            requestParams: {}
                        },
                        delete: true,
                        formLeft: {
