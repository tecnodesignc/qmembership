        ...
        computed: {
            crudData() {
                return {
                    ...
                    create: {
                        title: this.$tr('qmemebership.layout.profile.new'),
                        to: 'qmembership.admin.profile.create'
                    },
                    read: {
                        columns: [
                            {
                        ...
                        filters: {
                            congregationId: {
                                ...
                                props: {
                                    label: `${this.$tr('qmemebership.layout.congregation.title')}:`,
                                    options: [
                            ...
                            type: {
                                ...
                                props: {
                                    label: `${this.$tr('qmemebership.layout.profile.type')}:`,
                                    options: [
                                        {label: this.$tr('ui.label.all'), value: 0}
                                    ],
                                }
                        ...
                        formRight:{
                            ...
                            studyId: {
                                ...
                                props: {
                                    ...
                                    crudProps: {
                                        label: `${this.$tr('qmemebership.layout.study.title')}*`,
                                        rules: [
                                            val => !!val || this.$tr('ui.message.fieldRequired')
                                        ],
                                    },
                            ...
                            professionId: {
                                ...
                                props: {
                                    ...
                                    crudProps: {
                                        label: `${this.$tr('qmemebership.layout.profession.title')}*`,
                                        rules: [
                                            val => !!val || this.$tr('ui.message.fieldRequired')
                                        ],
                                    },
                            ...
                            ecclesiasticalAnswer:{
                                ...
                                props: {
                                    ...
                                    options: [
                                        {label: this.$tr('qmembership.layout.profile.ecclesiasticalAnswer.favorable'), value: 'favorable'},
                                        {label: this.$tr('qmembership.layout.profile.ecclesiasticalAnswer.unfavorable'), value: 'desfavorable'},
                                    ],
                                }
                            },
                            mediasSingle: {
